...
public class ScreenshotUtility {
	...
	public void captureScreenShotForFailedTestcase(WebDriver driver, String name) throws IOException {
		...
		TakesScreenshot scrShot = (TakesScreenshot) driver; // TakesScreenshot is the interface & getScreenshotAs is the
															// class
		File screenShot = scrShot.getScreenshotAs(OutputType.FILE);// screenshot will store in temporary path
//Below 20.21.22 are mentioning to create folder in the framework
